...
public class SimpleModelContainerRendererTest {
    ...
    SimpleModelContainerRenderer testObject = new SimpleModelContainerRenderer(new SimplePropertyNameMapper(),iconMapper);
